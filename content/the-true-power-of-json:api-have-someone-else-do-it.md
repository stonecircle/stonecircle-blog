...
You will need to create a database and create a user with write permissions to that database. Both
...
Let's say we are working on a blog and need to perform CRUD actions on posts. In the `models`
